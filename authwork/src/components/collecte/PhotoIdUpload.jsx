...
export default function PhotoIdUpload({ label, fieldName, photoValue, onChange }) {
    ...
    <div className="bg-white p-3 sm:p-4 rounded-lg border-2 border-dashed border-slate-300">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Button
          type="button"
          onClick={() => {
            const input = document.getElementById(`photo-id-camera-${fieldName}`);
        ...
        <Button
          type="button"
          onClick={() => {
            const input = document.getElementById(`photo-id-gallery-${fieldName}`);
            if (input) input.value = '';
            input?.click();
          }}
          variant="outline"
